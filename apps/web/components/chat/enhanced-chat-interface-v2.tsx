...
import { CitationSystem } from "../citations/citation-system"
...
export function EnhancedChatInterfaceV2() {
                        ...
                        <Card className={cn(
                          ...
                          <CardContent className="p-6">
                            {message.role === "user" ? (
                              ...
                              <div className={cn(
                                "text-base leading-relaxed text-primary-foreground",
                                /[\u0980-\u09FF]/.test(message.content) ? 'bangla' : ''
                              )}>
                                {message.content}
                              </div>
                            ) : (
                              // Assistant message - use citation system
                              <CitationSystem
